...
<body class="min-h-full flex items-center justify-center font-sans antialiased bg-slate-50 relative py-12">
    ...
    <div class="w-full max-w-xl p-6 relative z-10">
        ...
        <div class="bg-white/80 backdrop-blur-md rounded-3xl border border-slate-100 shadow-xl shadow-slate-100/40 p-8 sm:p-10">
            <h2 class="text-2xl font-black text-slate-800 mb-2 text-center tracking-tight">Daftar Akun Baru</h2>
            <p class="text-slate-500 mb-8 font-medium text-center text-sm">Lengkapi form di bawah ini untuk mulai meminjam.</p>
            ...
            <form action="/register" method="POST" enctype="multipart/form-data" class="space-y-5">
                ...
                <div x-data="{ 
                    ...
                    <label class="block text-sm font-bold text-slate-700 mb-2">Foto KTM</label>
                ...
                <button type="submit" 
                    class="w-full py-4 px-4 bg-teal-600 hover:bg-teal-700 active:bg-teal-800 text-white font-black rounded-2xl shadow-lg shadow-teal-600/30 transition-all duration-200 mt-4">
                    Daftar Akun
                </button>
            </form>
        </div>
